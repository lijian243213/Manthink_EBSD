...
enum _ev_t { EV_SCAN_TIMEOUT=1, EV_BEACON_FOUND,
             ...
             EV_TXCOMPLETE_INT,EV_TXOVER_MAC_NOPORT,EV_TXOVER_MAC_PORT,EV_NTRX,EV_BCN_GWCHG,EV_GBROAD,EV_FUOTA_UART1,EV_FUOTA_UART2};
...
MT_EV_TXCOMPLETE_INT,MT_EV_TXOVER_MAC_NOPORT,MT_EV_TXOVER_MAC_PORT,MT_EV_NTRX,MT_EV_BCN_GWCHG,MT_EV_GBROAD,MT_EV_FUOTA_UART1,MT_EV_FUOTA_UART2};
...
typedef struct t_ram_fun_lws
{
  ...
  s8_t (*LWS_GetSysTime)(int unit);
  u4_t (*LWS_GetUPseq)(void);
  void (*LWS_SetDeviceTimeReq)(void);
  bool 	(*LWS_SetClassMode)(u1_t classMode);
    void (*LWS_sendAlive)(void);
  LWERRO_t (*Join)(LWOP_t mode);
  LWERRO_t (*JoinReset)(LWOP_t mode);
  LWERRO_t (*LW_TxData)(u1_t * txBuffer,u1_t lenth,u1_t port,LWOP_t mode);
